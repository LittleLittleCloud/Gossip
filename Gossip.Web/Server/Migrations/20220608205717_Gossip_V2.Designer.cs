...
namespace Gossip.Web.Server.Migrations
{
    ...
    [Migration("20220608205717_Gossip_V2")]
    partial class Gossip_V2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gossip.Core.Comment", b =>
                {
                    ...
                    b.Property<long>("CreatedTimestampInSeconds")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gossip.Core.Like", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gossip.Core.Reply", b =>
                {
                    ...
                    b.Property<long>("CreatedWhenTimestampInSecond")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Gossip.Core.Comment", b =>
                {
                    ...
                    b.HasOne("Gossip.Core.Topic", "Topic")
                        .WithMany()
            ...
            modelBuilder.Entity("Gossip.Core.Like", b =>
                {
                    b.HasOne("Gossip.Core.Comment", "Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Gossip.Core.User", null)
                        .WithMany()
